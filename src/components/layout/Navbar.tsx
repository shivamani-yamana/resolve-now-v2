...
export default function Navbar({ className }: NavbarProps) {
  ...
  return (
    <nav
      className={cn(
        "fixed z-50 w-full max-w-7xl px-6 py-4 bg-white/80 backdrop-blur-sm rounded-full",
        className
      )}
    >
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link
            href="/login"
            className="px-4 py-2 rounded-full text-blue-600 hover:text-blue-800 transition-colors"
          >
            Login
          </Link>
          <Link
        ...
        <div className="md:hidden mt-4 py-4 bg-white rounded-2xl shadow-lg">
          <div className="flex flex-col space-y-4 px-6">
            ...
            <div className="flex flex-col space-y-2 pt-4 border-t">
              <Link
                href="/login"
                className="px-4 py-2 rounded-full text-center text-blue-600 hover:text-blue-800 transition-colors"
              >
                Login
              </Link>
              <Link
